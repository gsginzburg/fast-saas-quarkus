...
@ApplicationScoped
public class ClusterRepository implements PanacheRepositoryBase<Cluster, UUID> {

    public List<Cluster> findByStatus(ClusterStatus status) {
    ...
    public io.quarkus.hibernate.orm.panache.PanacheQuery<Cluster> queryAll() {
